...
const s = {
  ...
  addBtn:     {background:'#1a1e27',border:'1px solid #2d3548',color:'#B2B5BE',width:24,height:24,borderRadius:3,cursor:'pointer',fontSize:16,display:'flex',alignItems:'center',justifyContent:'center',fontFamily:"'Montserrat',sans-serif",flexShrink:0,zIndex:10},
  dropdown:   {position:'fixed',top:42,left:'auto',background:'#0d1017',border:'1px solid #2d3548',borderRadius:4,zIndex:9999,minWidth:120,padding:'4px 0',boxShadow:'0 8px 24px #000000CC'},
