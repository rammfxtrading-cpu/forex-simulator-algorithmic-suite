    ...
    <div style={s.root}>
      ...
      <div style={s.main}>
        ...
        {activeView === 'dashboard' && <>
          ...
          <div style={s.ctaRow}>
            <div style={{...s.ctaCard,borderColor:'#1E90FF60',background:'linear-gradient(135deg,rgba(3,15,32,0.55),rgba(4,26,48,0.55))'}} onClick={()=>setShowNew(true)}>
          ...
          {closedTrades.length === 0 ? (
            ...
            <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:10,marginBottom:20}}>
              {[
                ...
                <div key={stat.label} style={{...s.statCard,padding:20,background:'linear-gradient(135deg,rgba(3,15,32,0.55),rgba(4,26,48,0.55))',border:'1px solid rgba(30,144,255,0.45)',borderRadius:12}}>
            ...
            {/* EQUITY CURVE */}
            <div style={{borderRadius:12,padding:'20px 24px',marginBottom:20,background:'linear-gradient(135deg,rgba(3,15,32,0.55),rgba(4,26,48,0.55))',border:'1px solid rgba(30,144,255,0.45)',borderRadius:12}}>
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:16,marginBottom:20}}>
              <div style={{borderRadius:12,padding:'20px 24px',background:'linear-gradient(135deg,rgba(3,15,32,0.55),rgba(4,26,48,0.55))',border:'1px solid rgba(30,144,255,0.45)',borderRadius:12}}>
            ...
            {/* JOURNAL TABLE */}
            <div style={{borderRadius:12,padding:'20px 24px',marginTop:16,background:'linear-gradient(135deg,rgba(3,15,32,0.55),rgba(4,26,48,0.55))',border:'1px solid rgba(30,144,255,0.45)',borderRadius:12}}>
...
const s = {
  ...
  sidebar:{position:'relative',zIndex:1,width:230,flexShrink:0,background:'linear-gradient(135deg,rgba(3,15,32,0.55),rgba(4,26,48,0.55))',borderRight:'1px solid #0d2040',display:'flex',flexDirection:'column',backdropFilter:'blur(4px)'},
  ...
  emptyCard:{borderRadius:12,padding:'60px 40px',textAlign:'center',display:'flex',flexDirection:'column',alignItems:'center',background:'linear-gradient(135deg,rgba(3,15,32,0.55),rgba(4,26,48,0.55))',border:'1px solid rgba(30,144,255,0.45)',borderRadius:12},
