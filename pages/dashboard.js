          ...
          {closedTrades.length === 0 ? (
            ...
            <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:10,marginBottom:20}}>
              {[
                ...
                <div key={stat.label} style={{...s.statCard,padding:20,background:'rgba(5,15,40,0.22)',border:'1px solid rgba(30,144,255,0.45)',borderRadius:12}}>
            ...
            {/* EQUITY CURVE */}
            <div style={{borderRadius:12,padding:'20px 24px',marginBottom:20,background:'rgba(5,15,40,0.22)',border:'1px solid rgba(30,144,255,0.45)',borderRadius:12}}>
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:16,marginBottom:20}}>
              <div style={{borderRadius:12,padding:'20px 24px',background:'rgba(5,15,40,0.22)',border:'1px solid rgba(30,144,255,0.45)',borderRadius:12}}>
            ...
            {/* JOURNAL TABLE */}
            <div style={{borderRadius:12,padding:'20px 24px',marginTop:16,background:'rgba(5,15,40,0.22)',border:'1px solid rgba(30,144,255,0.45)',borderRadius:12}}>
...
const s = {
  ...
  emptyCard:{borderRadius:12,padding:'60px 40px',textAlign:'center',display:'flex',flexDirection:'column',alignItems:'center',background:'rgba(5,15,40,0.22)',border:'1px solid rgba(30,144,255,0.45)',borderRadius:12},
