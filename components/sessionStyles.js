...
export const s={
  ...
  togOn:{background:'rgba(255,255,255,0.1)',border:'1px solid rgba(255,255,255,0.25)',color:'#fff'},
  // Replay pill
  ...
  pillPause:{background:'rgba(255,255,255,0.1)',border:'1px solid rgba(255,255,255,0.2)'},
